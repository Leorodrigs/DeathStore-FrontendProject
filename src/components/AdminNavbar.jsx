        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-4 ml-6">
              <Link
                to="/admin/clients"
                className="bg-gradient-to-br from-yellow-200 to-amber-400 text-xl font-semibold text-stone-900 px-3 py-1 rounded shadow-md border border-amber-600 transition-all duration-300 hover:shadow-lg hover:brightness-190 active:brightness-95"
              >
                Clientes
              </Link>
              <Link
